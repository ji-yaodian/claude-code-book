...
:::tip 延伸阅读
- 权限系统如何与 UI 集成，请参阅[第 9 章：权限与安全系统](./permission-and-security)
- 状态管理的完整实现，请参阅[第 13 章：状态管理与数据持久化](./state-and-persistence)
- 命令系统如何触发 UI 渲染，请参阅[第 4 章：命令系统](./command-system)
:::
